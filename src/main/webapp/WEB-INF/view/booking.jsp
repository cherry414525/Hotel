    ...
    <div class="wrapper">
            ...
            <div class="col-md-6 ">
              <div id="bookingForm">
                ...
                <form method="POST" action="/booking/addbooking">
                  ...
                  <div class="form-group">
                    <label for="start_date">入住時間</label><small id="error"
                      style="color:red">${sessionScope.errordate}</small>
      ...
      <footer class="bg-light">
        <div class="container ">
          ...
          <hr>
          <p>
          <div><img src="http://localhost:8086/hotel_img/icon-map.webp" style="width: 1em; height: 1em;"> 地址:
            10491台北市中山區民生東路三段
          </div>
          <p>
          ...
          <p>
          <div><img src="http://localhost:8086/hotel_img/icon-phone.webp" style="width: 1em; height: 1em;"> 電話:
            0987654321</div>
          <p>
        </div>
      </footer>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        if (${ update }) {
         ...
         console.log("${ update }");
        var errorroom = "${sessionScope.errorroom}";
        if (errorroom != "") {
